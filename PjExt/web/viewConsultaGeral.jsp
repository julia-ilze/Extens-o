    ...
    <body>
        <div class="w3-row">
            ...
            <div class="menuLateral w3-col s2 w3-border-right">
                ...
                <div class="menuSair" style="padding-top: 300px">
            ...
            <div class="container w3-col s10"> 
                ...
                <header class="w3-black" id="home">
                    <div class=" w3-black">
                        <div class="titulo w3-black w3-center">
                            ...
                            <h4 style="margin-left: 700px"><b>Consultar Projetos</b></h4>
                        </div>
                    </div>
                </header>
                ...
                <div class="divConsulta w3-card">
                    <form action="" method="post">
                        <p style="float: left; margin-left: 100px;  margin-right: 1250px; margin-bottom: 10px">
                            ...
                            <button  type="submit" class="w3-button" ><img src="img/icon/consultar.svg"/></button>
                ...
                <div class="projetos w3-row-padding w3-padding-32 w3-margin-left w3-margin-right" style="margin-top: 130px;">
