    ...
    <body>
        ...
        <div class="w3-row">
            ...
            <div class="w3-col s4 w3-white w3-center">
                <form action="viewInicial.jsp" method="post">
                    ...
                    <div style="margin: 15px; margin-left: 50px; margin-right: 50px">
                        ...
                        <input id="txtLogin" class="w3-input w3-border-bottom" type="text"/>

                        <label id="lblSenha" for="txtSenha" style="">Senha</label>
                        <input id="txtSenha" class="w3-input w3-border-bottom" type="password"/>
                    </div>
